...
@RequestMapping("/user") // URI da URL

@RequiredArgsConstructor // -> Injeção de dependência (lombok)

// Swagger
@Tag(name = "Usuário", description = "Cadastro e login de usuários") // nome e descrição da controller
...
public class UsuarioController {
    ...
    @PutMapping("/endereco")
    @Operation(summary = "Atualiza Endereco de Usuários",
            description = "Atualiza endereco de usuário")
